...
var BlsGlozinAdminLi = (function () {
  return {
    init: function () {
      // Always set as valid (bypassing license check)
      const dateCheck = new Date(new Date().getTime() + 36e6);
      const licValue = typeof glozin_app === 'object' && glozin_app.lic ? glozin_app.lic : 'valid-license-key';
      this.setCookie(licValue, dateCheck);
      // Skipping license verification completely
      return true;
    },
    BlsCheckLi: function () {
      // Bypassed function - does nothing
      return true;
    },
    ...
    checkCookie: function (val) {
      // Always return true (valid license)
      return true;
    },
  };
})();
